...
while True:
    ...
    #Boucle à travers les visages détecté
    for (x, y, w, h) in faces:
        ...
        eyes = eye_cascade.detectMultiScale(face_cropped)
        if len(eyes) == 2:
        ...
        # Trouver le smiley correspondant
            ...
            eyes = eye_cascade.detectMultiScale(face_cropped, scaleFactor=1.1, minNeighbors=5)
